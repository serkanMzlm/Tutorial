...
class handsDetector():
    ...
    def __init__(self,mode=False,maxHands=2,detectionCon=0.5,trackCon=0.5): #en fazla algılayacağı el sayısı , el algılama hassasiyeti
        #sınıfın değikenlerine atama 
        self.mode = mode 
    ...
    def findHands(self,img,draw=True): #parmaklarda noktalar ve cizgi cizme (draw cizip cizmeme anlamı var)
